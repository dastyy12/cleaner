...
def guard_external_reply(update: Update, context: CallbackContext):
    ...
    # Проверка прав бота
    try:
        me = chat.get_member(context.bot.id)
...
def main():
    ...
    dispatcher.add_handler(MessageHandler(Filters.chat_type.groups, guard_external_reply))
